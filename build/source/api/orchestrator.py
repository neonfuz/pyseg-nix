...
#
    ...
    def load_config(self, config_file):
        ...
        try:
            bin_hash = self.make_hash("/var/lib/groundseg/groundseg")
    ...
    def load_urbits(self):
        ...
        if Utils.remove_urbit_containers():
            for p in self.config['piers']:
                ...
                data = None
                with open(f'/var/lib/groundseg/settings/pier/{p}.json') as f:
                    data = json.load(f)
...
#
    ...
    def delete_urbit(self, patp):
        ...
        os.remove(f"/var/lib/groundseg/settings/pier/{patp}.json")
        self.save_config()
    ...
    def boot_new_urbit(self, patp, key):
        ...
        with open(f'/var/lib/groundseg/settings/pier/{patp}.json', 'w') as f:
